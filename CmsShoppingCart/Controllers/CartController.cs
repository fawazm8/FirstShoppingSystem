...
using FirstShopping.Models.ViewModels.Cart;
using System;
...
namespace FirstShopping.Controllers
{
    public class CartController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                ViewBag.Message = "سلة المشتريات فارغة";
                return View();
            }
        ...
        public void PlaceOrder()
        {
            ...
            //client.Send("fawazm8@gmail.com", "fawazm8@gmail.com", "New Order", "You have a new order. Order number " + orderId);
